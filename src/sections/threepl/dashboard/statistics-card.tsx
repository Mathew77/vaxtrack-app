...
import { useFetchThreePlIndicators } from 'src/hooks/apis/dashboards/threepl/threepl-dashboard-hook';
...
export default function ThreePlStatisticsCard() {

  const { data, isLoading: isAllThreePlIndicators} = useFetchThreePlIndicators();

  const isLoading = isAllThreePlIndicators;
