...
export const MenAVaccine = ({
  ...
  const defaultFormData: MenAVaccineData = {
    ...
    slwgFiveMlSyringeQuantitySent: '',
    slwgFiveMlSyringeMismatchAdjusted: '',
    ...
    scsFiveMlSyringeQuantitySent: '',
    scsFiveMlSyringeMismatchAdjusted: '',
    ...
    threePlFiveMlSyringeQuantitySent: '',
    threePlFiveMlSyringeMismatchAdjusted: '',
    ...
    ehfFiveMlSyringeQuantityReceived: '',
    ehfFiveMlSyringeMismatchOutcome: '',
  ...
  const calculateLcsFiveMlSyringeMismatch = (lcsSentSyringe: string, antigenStock: string): string => {
    if (!lcsSentSyringe.trim() || !antigenStock.trim()) {
      return '';
    }
    const syringeSent = parseFloat(lcsSentSyringe) || 0;
    const antigenAmount = parseFloat(antigenStock) || 0;
    const syringeBaseValue = antigenAmount / 50;
    if (syringeSent === 0 && antigenAmount === 0) {
      return '';
    }
    if (Math.abs(syringeSent - syringeBaseValue) < 0.01) {
      return 'none';
    } else if (syringeSent > syringeBaseValue) {
      return 'excess';
    } else {
      return 'deficient';
    }
  ...
  const calculateLcsHalfMlSyringeMismatch = (lcsSentSyringe: string, antigenStock: string): string => {
    ...
    const syringeSent = parseFloat(lcsSentSyringe) || 0;
    const antigenAmount = parseFloat(antigenStock) || 0;
    const syringeBaseValue = antigenAmount / 2;
    if (syringeSent === 0 && antigenAmount === 0) {
      return '';
    }
    if (Math.abs(syringeSent - syringeBaseValue) < 0.01) {
  ...
  const calculateSlwgFiveMlSyringeMismatch = (slwgSentSyringe: string, lcsSentSyringe: string): string => {
  ...
  const calculateScsFiveMlSyringeMismatch = (scsSentSyringe: string, slwgSentSyringe: string): string => {
  ...
  const calculateThreePlFiveMlSyringeMismatch = (threePlSentSyringe: string, scsSentSyringe: string): string => {
  ...
  const calculateEhfFiveMlSyringeMismatch = (ehfReceivedSyringe: string, threePlSentSyringe: string): string => {
  ...
  const handleInputChange = (field: keyof MenAVaccineData) => (
    ...
    setFormData((prev) => {
      ...
      if (field === 'physicalStock' || field === 'fiveMlSyringePhysicalStock') {
        const antigenStock = field === 'physicalStock' ? value : newFormData.physicalStock;
        const syringeStock = field === 'fiveMlSyringePhysicalStock' ? value : newFormData.fiveMlSyringePhysicalStock;
        const syringeResult = calculate5mlSyringeMismatch(antigenStock, syringeStock);
        newFormData.fiveMlSyringeMismatchOutcome = syringeResult.outcome;
        newFormData.fiveMlSyringeMismatchAdjustedValue = syringeResult.adjustedValue;
      }
      ...
      if (field === 'lcsFiveMlSyringeQuantitySent') {
        newFormData.lcsFiveMlSyringeMismatchAdjusted = calculateLcsFiveMlSyringeMismatch(value, newFormData.physicalStock);
      }
      ...
      if (field === 'slwgFiveMlSyringeQuantitySent') {
        newFormData.slwgFiveMlSyringeMismatchAdjusted = calculateSlwgFiveMlSyringeMismatch(value, newFormData.lcsFiveMlSyringeQuantitySent || '');
      }
      ...
      if (field === 'scsFiveMlSyringeQuantitySent') {
        newFormData.scsFiveMlSyringeMismatchAdjusted = calculateScsFiveMlSyringeMismatch(value, newFormData.slwgFiveMlSyringeQuantitySent || '');
      }
      ...
      if (field === 'threePlFiveMlSyringeQuantitySent') {
        newFormData.threePlFiveMlSyringeMismatchAdjusted = calculateThreePlFiveMlSyringeMismatch(value, newFormData.scsFiveMlSyringeQuantitySent || '');
      }
      ...
      if (field === 'ehfFiveMlSyringeQuantityReceived') {
        newFormData.ehfFiveMlSyringeMismatchOutcome = calculateEhfFiveMlSyringeMismatch(value, newFormData.threePlFiveMlSyringeQuantitySent || '');
      }
            ...
            <>
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <TextField
                    ...
                    variant="outlined"
                    placeholder="Quantity Sent"
                    value={formData.lcsFiveMlSyringeQuantitySent}
                    onChange={handleInputChange('lcsFiveMlSyringeQuantitySent')}
                    disabled={!isLcsFieldsEditable}
                    type='number'
                    onKeyDown={preventInvalidKeys}
                  />
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <FormControl fullWidth>
                    <Select
                      value={formData.lcsFiveMlSyringeMismatchAdjusted}
                      onChange={handleInputChange('lcsFiveMlSyringeMismatchAdjusted')}
                      disabled={true}
                    >
                      <MenuItem value="">Select</MenuItem>
                      <MenuItem value="none">None</MenuItem>
            ...
            <>
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <TextField
                    ...
                    variant="outlined"
                    placeholder="Enter quantity"
                    value={formData.slwgFiveMlSyringeQuantitySent || ''}
                    onChange={handleInputChange('slwgFiveMlSyringeQuantitySent')}
                    disabled={!isSlwgFieldsEditable}
                    type='number'
                    onKeyDown={preventInvalidKeys}
                  />
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <FormControl fullWidth>
                    <Select
                      value={formData.slwgFiveMlSyringeMismatchAdjusted || ''}
                      onChange={handleInputChange('slwgFiveMlSyringeMismatchAdjusted')}
                      disabled={true}
                    >
                      <MenuItem value="">Select</MenuItem>
                      <MenuItem value="none">None</MenuItem>
            ...
            <>
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <TextField
                    ...
                    variant="outlined"
                    placeholder="Enter quantity"
                    value={formData.scsFiveMlSyringeQuantitySent || ''}
                    onChange={handleInputChange('scsFiveMlSyringeQuantitySent')}
                    disabled={!isScsFieldsEditable}
                    type='number'
                    onKeyDown={preventInvalidKeys}
                  />
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <FormControl fullWidth>
                    <Select
                      value={formData.scsFiveMlSyringeMismatchAdjusted || ''}
                      onChange={handleInputChange('scsFiveMlSyringeMismatchAdjusted')}
                      disabled={true}
                    >
                      <MenuItem value="">Select</MenuItem>
                      <MenuItem value="excess">Excess</MenuItem>
            ...
            <>
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <TextField
                    ...
                    variant="outlined"
                    placeholder="Enter quantity"
                    value={formData.threePlFiveMlSyringeQuantitySent || ''}
                    onChange={handleInputChange('threePlFiveMlSyringeQuantitySent')}
                    disabled={!isThreePlFieldsEditable}
                    type='number'
                    onKeyDown={preventInvalidKeys}
                  />
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <FormControl fullWidth>
                    <Select
                      value={formData.threePlFiveMlSyringeMismatchAdjusted || ''}
                      onChange={handleInputChange('threePlFiveMlSyringeMismatchAdjusted')}
                      disabled={true}
                    >
                      <MenuItem value="">Select</MenuItem>
                      <MenuItem value="none">None</MenuItem>
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <TextField
                    ...
                    variant="outlined"
                    placeholder="Enter quantity"
                    value={formData.ehfFiveMlSyringeQuantityReceived || ''}
                    onChange={handleInputChange('ehfFiveMlSyringeQuantityReceived')}
                    disabled={!isEhfFieldsEditable}
                    type='number'
                    onKeyDown={preventInvalidKeys}
                  />
              ...
              <Grid item xs={6}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <TextField
                    fullWidth
                    variant="outlined"
                    value={formData.ehfFiveMlSyringeMismatchOutcome || ''}
                    disabled={true}
                  />
                </Box>
              </Grid>
