...
import { useFetchStates, useFetchLgas, /* useFetchWards, */ useFetchMaximumStockReport } from 'src/hooks/apis/report/report-hook';
...
const MaximumStockReport: React.FC = () => {
  ...
  const { data: reportData, isLoading: reportLoading } = useFetchMaximumStockReport(
    selectedState,
    selectedLga,
    undefined,
    hasSearched
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: 'above_max_stock_flag',
        header: 'Above Max Stock',
        size: 100,
      },
      {
        accessorKey: 'allocated_vs_received',
        header: 'Allocated vs Received',
        size: 270,
      },
      {
...
export default MaximumStockReport;