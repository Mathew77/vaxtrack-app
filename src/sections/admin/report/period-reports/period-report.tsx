...
const REPORT_CONFIGS: Record<string, ReportConfig> = {
  ...
  'safety-boxes-retrieved': {
    ...
    columns: [
      { accessorKey: 'state', header: 'State', size: 150 },
      { accessorKey: 'lga', header: 'LGA', size: 150 },
      { accessorKey: 'bcg_safety_boxes', header: 'BCG', size: 120 },
      { accessorKey: 'hepb_safety_boxes', header: 'HepB', size: 120 },
      { accessorKey: 'bopv_safety_boxes', header: 'bOPV', size: 120 },
      { accessorKey: 'penta_safety_boxes', header: 'Penta', size: 120 },
      { accessorKey: 'pcv_safety_boxes', header: 'PCV', size: 120 },
      { accessorKey: 'ipv_safety_boxes', header: 'IPV', size: 120 },
      { accessorKey: 'mea_safety_boxes', header: 'MEA', size: 120 },
      { accessorKey: 'yf_safety_boxes', header: 'YF', size: 120 },
      { accessorKey: 'td_safety_boxes', header: 'TD', size: 120 },
      { accessorKey: 'mena_safety_boxes', header: 'MenA', size: 120 },
      { accessorKey: 'rota_safety_boxes', header: 'Rota', size: 120 },
      { accessorKey: 'hpv_safety_boxes', header: 'HPV', size: 120 },
      { accessorKey: 'mr_safety_boxes', header: 'MR', size: 120 },
      { accessorKey: 'mal_safety_boxes', header: 'MAL', size: 120 },
    ],
  },
  'non-functional-ehf': {
