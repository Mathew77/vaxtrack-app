...
import { useFetchStates, useFetchLgas, /* useFetchWards, */ useFetchVvmStageReport } from 'src/hooks/apis/report/report-hook';
...
const VvmStageReport: React.FC = () => {
  ...
  const { data: reportData, isLoading: reportLoading } = useFetchVvmStageReport(
    selectedState,
    selectedLga,
    undefined,
    hasSearched
