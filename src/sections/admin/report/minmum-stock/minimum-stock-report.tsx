...
const MinimumStockReport: React.FC = () => {
  ...
  const { data: reportData, isLoading: reportLoading } = useFetchMinimumStockFlagReport(
    selectedState,
    selectedLga,
    undefined,
    hasSearched
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: 'below_min_stock_flag',
        header: 'Below Min Stock',
        size: 130,
      },
      {
        accessorKey: 'stock_days',
        header: 'Stock Days',
        size: 100,
      },
      {
