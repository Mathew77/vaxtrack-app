                      ...
                      <>
                        ...
                        >
                          ...
                          {vaccines.map(vaccine => {
                            const fieldName = vaccineFieldMap[vaccine];
                            const allocatedFieldName = `${fieldName}_allocated`;
                            const actualValue = ward.sum_of_vaccine_at_ward_level[fieldName as keyof typeof ward.sum_of_vaccine_at_ward_level] as number | null;
                            const allocatedValue = ward.sum_of_vaccine_at_ward_level[allocatedFieldName as keyof typeof ward.sum_of_vaccine_at_ward_level] as number | null;
                            return (
                              <Tooltip
                                key={vaccine}
                                title={
