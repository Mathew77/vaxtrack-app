...
import { useFetchScsIndicators } from 'src/hooks/apis/dashboards/scs/scs-dashboard-hook';
...
export default function ScsStatisticsCard() {
  const { data, isLoading, error } = useFetchScsIndicators();
  ...
  if (error) {
    console.error('SCS Indicators Error:', error);
    return (
