...
import { PcvVaccineData } from 'src/types/vaccines/pcv';
import { PcvVaccine } from '../vaccine/pcv-vaccines';
...
export const PcvAllocation = ({
  ...
  const handleVaccineDataChange = (vaccineData: PcvVaccineData) => {
