              ...
              <>
                ...
                >
                  ...
                  {vaccines.map(vaccine => {
                    ...
                    const sum = wardData.sum_of_vaccine_at_ward_level;
                    const maximum = (sum as any)[fieldName] || 0;
                    const received = (sum as any)[`${fieldName}_received`] || 0;
                    const physicalStock = (sum as any)[physicalStockFieldName] || 0;
                    return (
                      <Tooltip
                        key={vaccine}
                        title={
                          <Box sx={{ p: 0.5 }}>
                            ...
                            <Typography variant="caption" sx={{ display: 'block' }}>Actual (SOH + Received): {formatNumber(received + physicalStock)}</Typography>
                            <Typography variant="caption" sx={{ display: 'block' }}>Percentage: {maximum > 0 ? (((received + physicalStock) / maximum) * 100).toFixed(1) : '0'}%</Typography>
                            <Typography variant="caption" sx={{ display: 'block', mt: 0.5, fontStyle: 'italic' }}>
                              {getStockStatusLabel(received, physicalStock, maximum)}
                            </Typography>
                          </Box>
                        }
                        arrow
                      ...
                      >
                        <TableCell
                          ...
                          sx={{
                            fontWeight: 700,
                            color: 'white',
                            bgcolor: getStockStatus(received, physicalStock, maximum),
                            borderRight: '0.5px solid rgba(255, 255, 255, 0.3)',
                            borderBottom: '0.5px solid rgba(0, 0, 0, 0.1)',
                            fontSize: '0.75rem',
                            cursor: 'pointer',
